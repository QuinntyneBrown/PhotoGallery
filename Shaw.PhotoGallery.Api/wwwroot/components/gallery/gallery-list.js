...
var GalleryListComponent = (function () {
    function GalleryListComponent($location, galleryActionCreator) {
        ...
        this.remove = function (gallery) { return _this.galleryActionCreator.remove({ entity: gallery }); };
        this.edit = function (gallery) { return _this.galleryActionCreator.edit({ entity: gallery }); };
...
//# sourceMappingURL=gallery-list.js.map