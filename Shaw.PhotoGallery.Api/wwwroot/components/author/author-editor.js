...
var AuthorEditorComponent = (function () {
    function AuthorEditorComponent($location, authorActionCreator, invokeAsync) {
        var _this = this;
        ...
        this.addOrUpdate = function () {
            _this.invokeAsync({
                action: _this.authorActionCreator.addOrUpdate,
                params: {
                    id: _this.id,
                    name: _this.name
                }
        ...
        this.remove = function () { return _this.authorActionCreator.remove({ id: _this.id }); };
    }
    AuthorEditorComponent = __decorate([
        ...
        component_decorators_1.CanActivate(["$route", "invokeAsync", "authorActionCreator", function ($route, invokeAsync, authorActionCreator) {
...
//# sourceMappingURL=author-editor.js.map